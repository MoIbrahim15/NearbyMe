...
public class LocationManager implements GoogleApiClient.ConnectionCallbacks,
    ...
    public static final int ANOTHER_LOCATION_CALL = 2;
    ...
    public void onMovingMapLocation(MapView mMapView, final ImageButton imageButton) {
        mMapView.getMapAsync(new OnMapReadyCallback() {
            @Override
            public void onMapReady(final GoogleMap googleMap) {
                googleMap.setOnCameraIdleListener(new GoogleMap.OnCameraIdleListener() {
                    ...
                    public void onCameraIdle() {
                        ...
                        LatLng mCurrentLatLog = googleMap.getCameraPosition().target;
                        Location mLocation = new Location("");
                        mLocation.setLatitude(mCurrentLatLog.latitude);
                        mLocation.setLongitude(mCurrentLatLog.longitude);
                        operationListener.onOperationCompleted(ANOTHER_LOCATION_CALL, mLocation);
                    }
                });
